"""
A script to generate realistic synthetic data for the construction project dashboard.

This script creates multiple CSV files with synthetic data that mimics real-world
construction project management scenarios. The data covers project metadata, status,
stages, budget variance, resource allocation, and workload distribution.
"""
...
def main():
    ...
    """
    print("🏗️ Generating data for the construction dashboard...")
